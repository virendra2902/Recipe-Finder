...
import './nutritionanalysisresult.css';
...
const NutritionAnalysisResult = () => {
  ...
  const fetchNutritionData = async () => {
    try {
      const apiId = 'faea4a2187'; // Replace with your API ID
      const apiKey = 'b4776e1442b8bde3305b57a7f76c14fenf'; // Replace with your API key
